...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LastUpdateInfo) DeepCopyInto(out *LastUpdateInfo) {
	*out = *in
	in.UpdateTime.DeepCopyInto(&out.UpdateTime)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LastUpdateInfo.
func (in *LastUpdateInfo) DeepCopy() *LastUpdateInfo {
	if in == nil {
		return nil
	}
	out := new(LastUpdateInfo)
	in.DeepCopyInto(out)
	return out
}
